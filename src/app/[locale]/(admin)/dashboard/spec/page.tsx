    ...
    <main className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-4xl mx-auto">
          ...
          <table className={TABLE_CLS}>
            ...
            <tbody>
              {[
                ...
                ['/ja/legal/*', '法務3ページ', '特商法表記（株式会社フライトライブ）・利用規約・プライバシーポリシー（全ページフッターからリンク）'],
        ...
        <section id="operations" className={SECTION_CLS}>
          ...
          <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
            <li>Stripe 本番アカウントの審査・本番キーへの切り替え（現在テストモード）＋本番 Webhook の再作成</li>
            <li>Vercel Pro プランへの切り替え（商用利用）</li>
            <li>Supabase 有料プラン化（無料枠は放置で自動停止するため）</li>
            <li>サービス詳細ページの【仮】項目（敷地・入場方法・設備）の正式文面への差し替え</li>
            <li>貸切セット券の自主管理規則の正式文面への差し替え（現在は仮文面）</li>
            <li>銀行振込フローの実決済テスト（現在未テスト）</li>
            <li>テスト用チケット（01〜99）とテスト用アカウント・テスト予約の削除</li>
          </ul>
          <p className={P_CLS}>
            対応済み: 特商法表記・利用規約・プライバシーポリシー（/ja/legal/*・2026-07-19）
          </p>
        </section>
